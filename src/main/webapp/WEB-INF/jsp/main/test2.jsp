...
<div id="seachContant" >
	<div id="searchCompany">
		<input type="email" class="item form-control" placeholder="고객사 입력" data-live-search="true" >
		<button type="button" class="item btn btn-primary">검색</button>
	</div>

	<div id="searchEtc">
		<div class="item dropdown">
			  <input type="text" id="myInput"  onclick="myFunction()" class="dropbtn form-control" placeholder="경조사 검색" onkeyup="filterFunction()">

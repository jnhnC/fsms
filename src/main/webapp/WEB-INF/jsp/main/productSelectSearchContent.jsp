...
<!-- currentCss -->
<link href="/css/contents/productSelectSearchContent.css" rel="stylesheet">

<meta name="viewport" content="width=device-width, initial-scale=1">
<div id="productSelectSearchContent">
...
$('.tablebox tbody tr').click(function(){
	...
	var url = '/productSelectRegContent';
    $.ajax({
        type        :    "post",
        url : url,
        dataType    :    'html',

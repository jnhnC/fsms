...
<link href="/css/contents/customSignRegContent.css" rel="stylesheet">


<div id="customSignRegContent" >
	...
	<div class="item"><!--5  -->
		...
		<div class="tab-wrapper">
			...
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link active">상품선택내역</a></li>
				<li class="nav-item"><a class="nav-link">장례일정</a></li>
								...
								<tbody>
									...
									<tr>
										...
										<td class="value">
											<div class="datebox">
												<div class="datePickerbox">
													<input type="text" class="datePicker" id="suplDate"
														class="form-control today" autocomplete="off"
														onfocus="this.blur()" inputmode="none"> <i
														class="bi bi-calendar-check calendar-icon"></i>
												</div>
									...
									<tr>
										...
										<td class="value">
											<div class="datebox">
												<div class="datePickerbox">
													<input type="text" class="datePicker" id="flagDate"
														class="form-control today" autocomplete="off"
														onfocus="this.blur()" inputmode="none"> <i
														class="bi bi-calendar-check calendar-icon"></i>
												</div>

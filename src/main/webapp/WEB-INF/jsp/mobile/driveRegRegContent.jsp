...
<link href="/css/mobile/driveRegRegContent.css" rel="stylesheet">


<div id="driveRegRegContent">
	<div class="item"> <!--1  -->
	...
	<div class="item"><!--3  -->
		<table class="table" style="font-size: calc(0.26vw + 10.08pt);">
			<tbody>
				...
				<tr>
					<td class="title">배차등록일시</td>
					<td class="value" colspan="3"></td>
				</tr>
				<tr>
					<td class="title">배차접수일시</td>
					<td class="value" colspan="3"></td>
				</tr>
				<tr>
					<td class="title">운행등록일시</td>
					<td class="value" colspan="3"></td>
				</tr>
			</tbody>
		</table>
	...
	<div class="item text-end"><!--4  -->
		<button class="btn btn-primary shadow-sm pt-1">
			<div style="font-size: calc(0.26vw + 9.08pt);">배차완료</div>
		</button>
	</div>

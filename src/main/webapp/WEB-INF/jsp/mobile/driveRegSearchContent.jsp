...
<!-- currentCss -->
<link href="/css/mobile/driveRegSearchContent.css" rel="stylesheet">

<div id="driveRegSearchContent"  style="min-width:360px;">
...
$('.tablebox tbody tr').click(function(){
	...
	var url = '/mobile/driveRegRegContent';
    $.ajax({
        type        :    "post",
        url : url,
        dataType    :    'html',

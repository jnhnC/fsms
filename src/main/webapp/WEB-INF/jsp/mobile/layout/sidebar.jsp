		    ...
		    <div class="sidebar-menu">
				...
				<ul>
					<li class="sidebar-item">
		            	...
		            	<ul id="" class="sidebar-dropdown" style="">
							<li class="sub-item"><a class="sidebar-link" onclick="changeContents('/mobile/teamSearchContent')">팀장배정</a></li>
							<li class="sub-item"><a class="sidebar-link" onclick="changeContents('/mobile/exSearchContent')">출고처리</a></li>
							<li class="sub-item"><a class="sidebar-link" onclick="changeContents('/mobile/productSearchContent')">상품조회</a></li>
							<li class="sub-item"><a class="sidebar-link" onclick="changeContents('/mobile/callSearchContent')">유선상담</a></li>
						</ul>

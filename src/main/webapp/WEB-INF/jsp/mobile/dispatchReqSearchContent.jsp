...
<!-- currentCss -->
<link href="/css/mobile/dispatchReqSearchContent.css" rel="stylesheet">

<div id="dispatchReqSearchContent"  style="min-width:360px;">
...
$('.tablebox tbody tr').click(function(){
	...
	var url = '/mobile/dispatchReqRegContent';
    $.ajax({
        type        :    "post",
        url : url,
        dataType    :    'html',

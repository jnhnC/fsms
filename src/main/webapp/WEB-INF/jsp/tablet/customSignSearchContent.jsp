...
<link href="/css/tablet/customSignSearchContent.css" rel="stylesheet">

<div id="customSignSearchContent" class="card mx-2 rounded border-0" style="box-shadow: 0 0.5rem 0.5rem rgb(0 0 0 / 2%) !important;">

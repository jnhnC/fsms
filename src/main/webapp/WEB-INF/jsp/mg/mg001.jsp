...
<!-- currentCss -->
<link href="./css/mg/mg001.css" rel="stylesheet">

<div id="mgSearchContent" class="card mx-2 rounded border-0" style="box-shadow: 0 0.5rem 0.5rem rgb(0 0 0 / 2%) !important;">
...
$('#mgSearchContent').on('click', '.tablebox tbody tr', function(){

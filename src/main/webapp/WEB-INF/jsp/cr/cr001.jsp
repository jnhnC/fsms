...
<link href="./css/cr/cr001.css" rel="stylesheet">
...
$('#consultResultSearchContent').on('click', '.tablebox tbody tr', function(e){
    ...
    $.ajax({
        ...
        success        :    function(data){
        	setTimeout(function() {
        	  ...
        	  $('#consultResultSearchContent').off("click");
        }
    	, beforeSend: function() {
